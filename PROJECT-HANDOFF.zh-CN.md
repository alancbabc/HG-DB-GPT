...
> 对应提交：`ab38e7ff2a344aed818b4301a2a368cd19cfdf37`  
...
| `dev_deploy` | `ab38e7ff` | 当前完整集成分支：包含以上内容及 SQLite、离线模型、安装部署和工具修复 |
...
当前 HEAD `ab38e7ff` 的主题是 Stage 21.4 Windows 离线一键安装。主要结果：
...
- 确认当前分支为 `dev_deploy`，HEAD 和标签是否仍与本文一致。
